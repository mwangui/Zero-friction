...
import { KpiDto, AlertDto } from '../core/models/api.models';
import {
  buildTrafficLatencyOption,
  buildIncidentRegionOption,
  buildCpuLoadByDeviceOption,
} from './chart-config.factory';
  ...
  ngOnInit(): void {
    forkJoin({
      ...
      next: (data) => {
        ...
        this.cpuLoadChartOptions.set(buildCpuLoadByDeviceOption(data.cpuLoad));
